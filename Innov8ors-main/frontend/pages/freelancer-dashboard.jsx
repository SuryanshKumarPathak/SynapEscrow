          ...
          <div className="grid gap-3 md:grid-cols-2">
            {projects.map((project) => (
              ...
              >
                ...
                <p className="mt-1 text-xs text-slate-500">Budget: {formatCurrency(project.budget)}</p>
          ...
          milestones.map((milestone) => (
            <article key={milestone._id} className="card space-y-3">
              ...
              <div className="grid gap-2 text-sm md:grid-cols-3">
                <p>
                  <span className="font-medium">Payment:</span> {formatCurrency(milestone.payment_amount)}
                </p>
                <p>
