      ...
      {summary ? (
        <section className="card">
          ...
          <div className="mt-3 grid gap-3 text-sm md:grid-cols-3">
            <p>
              <span className="font-medium">Released:</span> {formatCurrency(summary.payments_released)}
            </p>
            <p>
              <span className="font-medium">Refunded:</span> {formatCurrency(summary.refunded_amount)}
            </p>
            <p>
